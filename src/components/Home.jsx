        ...
        <>
            <section className="card rounded-none lg:card-side bg-violet-50 px-5 lg:px-20 flex justify-between ">
                <div className="text-start flex flex-col justify-center">
                    ...
                    <p className='py-8 text-info'>Explore thousands of job opportunities with all the <br /> information you need. Its your future. Come find it. Manage all <br /> your job application from start to finish.</p>
                ...
                <figure className='mt-5 lg:mt-0'><img className='h-[30vh] lg:h-[70vh]' src="banner.png" alt="Album" /></figure>

            </section>
            <section className='my-container lg:mt-10'>
                <h2 className='text-3xl font-semibold pb-5'>Job Category List</h2>
                <p className='text-info'>Explore thousands of job opportunities with all the information you need. Its your future.</p>
            ...
            <section className='my-container'>
                ...
                {!showAll && (
                    <span onClick={handleShowAll}>
                        <button className="mb-5 lg:mb-0 font-semibold bg-gradient-to-r from-blue-400 to-purple-400 p-2 rounded-md text-white">See All Jobs</button>
                    </span>
                )}
            </section>
        </>
